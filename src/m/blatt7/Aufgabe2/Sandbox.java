...
public class Sandbox
{
	...
	{
		shaderProgram    = new ShaderProgram( "OBJ_Sample_vsB7A2.glsl", "OBJ_Sample_fsB7A2.glsl" );
	...
	public void draw()
	{
		...
		shaderProgram.setUniform( "ligthPosition" , new Vec3(10,10,10));
