...
public class Sphere
{
	public static Mesh createMesh( float radius, int latitudeBands, int longitudeBands, float xAchse, float yAchse, float zAchse)
	{
	    ...
	    for( int latitude = 0; latitude <= latitudeBands; ++latitude )
	    {
	        for( int longitude = 0; longitude <= longitudeBands; ++longitude )
	        {
	            ...
	            positions[ vertex * 3 + 0 ] = (radius * x)+xAchse;
	            positions[ vertex * 3 + 1 ] = (radius * y)+yAchse;
	            positions[ vertex * 3 + 2 ] = (radius * z)+zAchse;
