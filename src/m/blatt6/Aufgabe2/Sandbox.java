...
public class Sandbox
{
	...
	private Mesh		  flag = Flag.createFlagMesh(350, 210, 3.5f, 2.1f);
	...
	{
		shaderProgram    = new ShaderProgram( "Color_vsA2.glsl", "Color_fsA2.glsl" );
	...
	public void draw()
	{
		...
		shaderProgram.setUniform( "uTime", time );
		time+=.1;
	//	System.out.println(time);
		...
		flag.setAttribute(1, colors, 3);
		flag.draw(GL_TRIANGLES);
	}
